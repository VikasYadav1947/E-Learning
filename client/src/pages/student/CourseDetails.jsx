...
const CourseDetails = () => {
  ...
  const {allCourses,calculateNoOfLectures,
 ...
 if (!courseData) {
  return <div className="p-10 text-center text-gray-500">Loading course data...</div>;
}
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 
      ...
      <div className='max-w-xl z-10 text-gray-500'>
         ...
         <div dangerouslySetInnerHTML={{ __html: courseData.courseDescription.slice(0,200) }} />
         ...
         {/* review and rating  */}
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                 ...
                 <p className='text-sm'> course by <span className='text-blue-600 underline '>vikas yadav </span></p>
                ...
                <div className={`overflow-hidden transition-a6ll duration-300  ${openSections[index] ?'max-h-96':'max-h-0' }`}>
                 ...
                 <div className='py-20 text-sm md:text-deafult'>
                  ...
                  <div dangerouslySetInnerHTML={{ __html: courseData.courseDescription }} className='
                  pt-4 rich-text ' />
      ...
      bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5 '> 
            ...
            <div className='flex items-center text-sm ms:text-default gap-4 pt-2 
