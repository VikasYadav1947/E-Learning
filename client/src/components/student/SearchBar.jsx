...
const SearchBar = ({data}) => {
  ...
  return (
    // <div className="flex justify-center items-center min-h-screen"> 
      <form onSubmit={onSearchHandler} className='  max-w-xl w-full md:h-14 h-12 flex justify-centre items-centre bg-white border border-gray-500/20 rounded mx-auto' >
